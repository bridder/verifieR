          ...
          code =
            {
              expect_error(object = verify_class_and_typeof(tested_value = list(list_1 = list("a","b"),list_2 = list(1.1,2.9),list_3 = list(15.2,-119.0)),
                           ...
                           regexp = "Argument \\'list_of_length_3\\' must have length >= required_length_min; required_length_min = 1017L; asserted length = 3L\\.$")
            })
          ...
          code =
            {
              expect_error(object = verify_class_and_typeof(tested_value = as.logical(c(NA,NA,NA,NA,NA)),
                                                            ...
                                                            required_typeof = "logical"),
                           regexp = "Argument \\'NA_5_elements\\' must have length >= required_length_min; required_length_min = 6L; asserted length = 5L\\.$")
            })
