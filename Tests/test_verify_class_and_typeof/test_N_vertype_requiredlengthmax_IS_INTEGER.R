          ...
          code =
            {
              ...
              expect_error(object = verify_class_and_typeof(tested_value = 3.2,
                ...
                required_length_max = 9.2,
                                                tested_value_name =  "fried_eggs",
                                                required_classes = "numeric",
                                                required_typeof = "double",
                                                regexp = "^required_length_max must be of type \\'integer\\', asserted type is 'double'\\.$"))
                           })
          ...
          code =
            {
              ...
              expect_error(object = verify_class_and_typeof(tested_value = 3.2,
                required_length_min = 1L,
                required_length_max = list(5L),
                                                tested_value_name = "fried_eggs",
                                                required_classes = "numeric",
                                                required_typeof = "double",
                                                regexp = "^required_length_max must be of type \\'integer\\', asserted type is 'list'\\.$"))
            })
          ...
          code =
            {
              ...
              expect_error(object = verify_class_and_typeof(tested_value = 3.2,
                ...
                required_length_max = "1L",
                                                ...
                                                required_classes = "numeric",
                                                required_typeof = "double",
                                                regexp = "^required_length_max must be of type \\'integer\\', asserted type is 'character'\\.$"))
            })
