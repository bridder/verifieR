...
required_length_max = 3L,
                                                ...
                                                required_classes = "integer",
                                                required_typeof = "integer"),
                                                regexp = "^Argument \\'thirteen_ones\\' must have length >= required_length_max; required_length_max = 3L; asserted length = 0L\\.$")
            })
...
test_that(desc = "tested_value length is above the maximum; 5L asserted NA values but 6L required.",
          code =
            {
